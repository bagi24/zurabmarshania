document.addEventListener("DOMContentLoaded", function () {
  ...
  const translations = {
    ge: {
      ...
      "#call_desc": "ვიზიტის დასაჯავშნად აუცილებლად დაგვიკავშირდით წინასწარ",
      ...
      "#clock_description":
        "მოგესალმებით. გმადლობთ, რომ დაგვიკავშირდით. გთხოვთ გაითვალისწინოთ, რომ პაციენტების მიღება სრულდება წინასწარი ჩაწერით, ნომერზე: 599 641187. მიღების საათებია ორშაბათიდან პარასკევის ჩათვლით, 10:00–15:00 საათამდე. მისამართი: თევდორე მღვდლის ქუჩა №48, კორპუსი 1ა, ბინა 2.",
      "#brand-desc":
